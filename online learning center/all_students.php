        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="list-group">
                    ...
                    <a href="all_students.php" class="list-group-item list-group-item-action active"><i class="fa fa-user"></i> All Students</a>
                    <a href="edit_students.php" class="list-group-item list-group-item-action"><i class="fas fa-edit"></i> Edit Students</a>
                </div>
            </div>
            <div class="col-sm-9">
                <h2 class="text-primary"><i class="fa fa-user"></i> All Students <small>Students Overview</small></h2>
                <ol class="breadcrumb">
