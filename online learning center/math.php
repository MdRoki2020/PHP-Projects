...
<section>
    <div class="container">
        <h1 class="tableHeading text-center">Math</h1>

        <table class="table table-striped table table-bordered table-responsive">
            <thead>
            <tr>
                <th>Video Name</th>
                <th>Video</th>
            ...
            <?php
            $runQuery=mysqli_query($connect,"SELECT * FROM `math` ");
            ...
            <tr>
                ...
                <td><video width="320" height="176" controls >
                        <source src="math_videos/<?php echo $row['video']?>" type="video/mp4">
                    </video></td>
