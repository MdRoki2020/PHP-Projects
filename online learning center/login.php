    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar ">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav  ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link bg-primary" href="login.php">Student Portal <i class="fas fa-user-graduate"></i></a>
                </li>
                <li class="nav-item">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <div class="loginform">
                <div class="text-center mt-2"><h3>Student Portal Login</h3></div>
                <div class="popupMsz">
                    <?php
                ...
                <p class="mt-2">Hvn't An Account? <span><a href="register.php"> Registration</a></span></p>
            </div>
